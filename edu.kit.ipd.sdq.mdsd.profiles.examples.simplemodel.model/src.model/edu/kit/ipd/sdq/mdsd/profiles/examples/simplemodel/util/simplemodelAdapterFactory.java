/**
 */
package edu.kit.ipd.sdq.mdsd.profiles.examples.simplemodel.util;
 ...
 * <!-- end-user-doc -->
 * @see edu.kit.ipd.sdq.mdsd.profiles.examples.simplemodel.simplemodelPackage
 * @generated
 */
public class simplemodelAdapterFactory extends AdapterFactoryImpl {
     ...
     * @generated
     */
    protected simplemodelSwitch<Adapter> modelSwitch =
        new simplemodelSwitch<Adapter>() {
            @Override
    ...
    /**
     * Creates a new adapter for an object of class '{@link edu.kit.ipd.sdq.mdsd.profiles.examples.simplemodel.A <em>A</em>}'.
     * <!-- begin-user-doc -->
    ...
    /**
     * Creates a new adapter for an object of class '{@link edu.kit.ipd.sdq.mdsd.profiles.examples.simplemodel.B <em>B</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
    ...
    /**
     * Creates a new adapter for an object of class '{@link edu.kit.ipd.sdq.mdsd.profiles.examples.simplemodel.Super <em>Super</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
