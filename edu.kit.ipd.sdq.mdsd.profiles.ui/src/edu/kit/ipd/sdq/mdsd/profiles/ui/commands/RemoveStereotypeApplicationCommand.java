...
public class RemoveStereotypeApplicationCommand extends
	...
	public RemoveStereotypeApplicationCommand(EStereotypableObject eStereotypableObject, Stereotype stereotype, StereotypeApplication stereotypeApplication) {
	...
	public void undo() {
		...
		for (EStructuralFeature structuralFeature : structuralFeatures) {
			if (!"appliedTo".equals(structuralFeature.getName()) && !"profileApplication".equals(structuralFeature.getName()) &&!"extension".equals(structuralFeature.getName())) {
