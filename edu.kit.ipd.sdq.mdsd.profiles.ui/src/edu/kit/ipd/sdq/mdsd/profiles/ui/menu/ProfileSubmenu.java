...
public class ProfileSubmenu extends CompoundContributionItem {
    ...
    private IContributionItem[] getContributionItemsForSelectedElement(EStereotypableObject eStereotypableObject) {
        ...
        return getContributionItemsForAppliedAndApplicableStereotypes(contributionCount, stereotypeName2ConfigElemMap,
                stereotype2ApplicableAppliedMap, commandableStereotypes);
    }

    private void removeAppliedStereotypesOfOtherProfiles(EList<Stereotype> appliedStereotypes) {
    ...
    private Map<String, IConfigurationElement> mapStereotypeNames2ConfigElements(IConfigurationElement[] configElements) {
    ...
    private Map<Stereotype, Pair<Boolean, Boolean>> mapStereotypes2CommandTypes(
            final EList<Stereotype> applicableStereotypes, EList<Stereotype> appliedStereotypes, int contributionCount) {
    ...
    private IContributionItem[] getContributionItemsForAppliedAndApplicableStereotypes(int contributionCount,
    ...
    private IContributionItem getContributionItem(String currentStereotypeName, IConfigurationElement configElement,
            String profileName, boolean isUnapply) {
        String label = isUnapply ? Constants.getDefaultUnapplyLabel(currentStereotypeName) : Constants
        ...
        IContributionItem contributionItem = createContributionItem(label, currentStereotypeName, profileName,
                isUnapply);
    ...
    private IContributionItem createContributionItem(final String label, final String stereotypeName,
            final String profileName, boolean isUnapply) {
