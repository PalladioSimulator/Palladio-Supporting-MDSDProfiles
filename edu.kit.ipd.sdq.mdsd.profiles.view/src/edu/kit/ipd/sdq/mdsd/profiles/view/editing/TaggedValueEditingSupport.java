...
public class TaggedValueEditingSupport extends EditingSupport {
	...
	private static Logger logger = Logger
			.getLogger(TaggedValueEditingSupport.class);
	...
	public TaggedValueEditingSupport(TableViewer tableViewer,
	...
	public TaggedValueEditingSupport(TableViewer tableViewer,
			EditingDomain editingDomain, EStructuralFeature eStructuralFeature) {
		super(tableViewer);
		this.viewer = tableViewer;
		this.editingDomain = editingDomain;
	...
	protected CellEditor getCellEditor(Object element) {
		EAttribute attr = (EAttribute) ((IEMFEditObservable) element)
		...
		if (((Object) attr.getEType()) instanceof String) {
			...
			comboBoxEditor = new ComboBoxViewerCellEditor(viewer.getTable(),
	...
	protected Object getValue(Object element) {
		...
		EAttribute attr = (EAttribute) ((IEMFEditObservable) element)
				.getStructuralFeature();
		Object obj = ((EObject) ((IEMFEditObservable) element).getObserved())
				.eGet(attr);
		logger.info(attr);
		logger.info(obj);
	...
	protected void setValue(Object element, Object value) {
		try {
			EAttribute attr = (EAttribute) ((IEMFEditObservable) element)
					.getStructuralFeature();
			Object obj = ((EObject) ((IEMFEditObservable) element)
					.getObserved()).eGet(attr);
			editingDomain = AdapterFactoryEditingDomain
					.getEditingDomainFor(attr.eContainer());
			Command cmd = null;
			...
			if (obj instanceof String) {
				...
				EEnumLiteral newEnum = ((EEnumLiteral) obj).getEEnum()
						.getEEnumLiteral((String) value);
				if (obj instanceof Enumerator) {
					Enumerator oldEnum = (Enumerator) obj;
					if (oldEnum != null) {
						cmd = SetCommand.create(editingDomain,
								((IEMFEditObservable) element).getObserved(),
								attr, newEnum);
						editingDomain.getCommandStack().execute(cmd);
					}
				}
