...
/**
 * Utility to deliver the list of EAttributes, which will be used for data binding between the model and UI.
 * 
 * @author emretaspolat
 *
 */
public class FeatureGetterUtility {
	 ...
	 */
	public static List<EAttribute> getFeatureListOfStereotype(Stereotype stereotype) {
	 ...
	 * @return List<EAttribute> EAttributes of Stereotype
	 */
	public static List<EAttribute> getFeatureListOfStereotypeApplication(StereotypeApplication stereotypeApplication) {
		if (stereotypeApplication == null) {
			return new ArrayList<EAttribute>();		
		} else {
			logger.info("EAttributes of " + stereotypeApplication + ": " + stereotypeApplication.eClass().getEAllAttributes());
			return stereotypeApplication.eClass().getEAllAttributes();
		}
	}
	
	/**
	 * Returns the list of EAttributes for the given Stereotype Application by getting first to the applied Stereotype.
	 * 
	 * @param stereotypeApplication
	 * @return List<EAttribute> EAttributes of Stereotype of Stereotype Application
	 */
	public static EList<EAttribute> getFeatureListOfSTFromSA(StereotypeApplication stereotypeApplication) {
...
//	}
//	
//	public static EStructuralFeature getFeatureByStereotypeApplicationSelection(StereotypeApplication stereotypeApplication) {
//		
...
//	}
//	
//	public static EStructuralFeature getFeatureOverStereotypeApplicationtoStereotype(StereotypeApplication stereotypeApplication) {
//		
//		StereotypeApplication sa = stereotypeApplication;
//		EList<EStructuralFeature> eAllStructuralFeatures = sa.getStereotype().eClass().getEAllStructuralFeatures();
//
//		if (!eAllStructuralFeatures.isEmpty()) {
//			try {
//				for (EStructuralFeature feature : eAllStructuralFeatures) {
