 ...
 * 
 * It is intended to be the root of all objects to which a stereotype can be applied.
 * 
...
public interface EStereotypableObject extends EObject {
     ...
     * @return The applications of the specified stereotype for this element, or empty list if no
     *         such stereotype application exists.
     */
    EList<StereotypeApplication> getStereotypeApplications(Stereotype stereotype);

    /**
     * Retrieves the applications of the stereotype with the specified qualified name for this
     * element.
     * 
     * @param qualifiedName
     *            The qualified name of the stereotype for which to retrieve the applications.
     * @return The applications of the stereotype with the specified qualified name for this
     *         element, or empty list if no such stereotype application exists.
     */
    EList<StereotypeApplication> getStereotypeApplications(String qualifiedName);
    ...
    /**
     * Retrieves the stereotype with the specified qualified name that is applied to this element.
     * 
     * @param qualifiedName
     *            The qualified name of the applied stereotype to retrieve.
     * @return The stereotype with the specified qualified name that is applied to this element, or
     *         null if no such stereotype is applied.
     */
     ...
     * @return True if the specified stereotype is applicable to this element, otherwise false.
     */
     ...
     * @param stereotype
     *            The stereotype in question.
     * @return True if the specified stereotype is applied to this element, otherwise false.
     */
    ...
    /**
     * Retrieves the stereotypes that are applicable to this element, including those that are
     * already applied.
     * 
     ...
     * the stereotype extensions are checked.
     * 
     * @return The stereotypes of the given profile that are applicable to this element.
     */
     ...
     * @return The stereotype with the specified qualified name that is applicable to this element,
     *         or null if no such stereotype is applicable.
     */
    ...
    /**
     * Saves the total profile application that contains this element to a profile application file.
     * Multiple profile applications are saved if this element has stereotypes from multiple
     * profiles applied.
     */
