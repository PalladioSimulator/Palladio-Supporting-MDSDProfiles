 ...
 * @generated
 */
public class WriterImpl extends EStereotypableObjectImpl implements Writer {
    /**
    ...
    public EList<Book> getBooks() {
        if (books == null) {
            books = new EObjectResolvingEList<Book>(Book.class, this, LibraryPackage.WRITER__BOOKS);
        }
        return books;
    }
