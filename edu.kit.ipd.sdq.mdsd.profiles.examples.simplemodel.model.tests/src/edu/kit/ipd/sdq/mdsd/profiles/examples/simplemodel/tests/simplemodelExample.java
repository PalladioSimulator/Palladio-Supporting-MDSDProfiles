...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>simplemodel</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class simplemodelExample {
    ...
    public static void main(String[] args) {
        ...
        if (args.length == 0) {
            ...
            try {
                Resource resource = resourceSet.createResource(URI.createURI("http:///My.simplemodel"));
                A root = simplemodelFactory.eINSTANCE.createA();
